 ...
 */
final class Version20240319095153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE area (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, parent_id INT NOT NULL, name VARCHAR(255) NOT NULL, rock_type VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_D7943D68F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
